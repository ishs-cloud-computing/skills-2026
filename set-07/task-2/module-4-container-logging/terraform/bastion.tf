...
printf 'PasswordAuthentication yes\n' > /etc/ssh/sshd_config.d/00-o11y-pwauth.conf
...
resource "aws_instance" "bastion" {
  ...
  subnet_id              = aws_subnet.this["o11y-subnet-pub-a"].id
